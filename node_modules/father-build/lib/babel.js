...
function _ref() {
  _ref = _asyncToGenerator(function* (opts) {
    ...
    function transform(opts) {
      ...
      return babel.transform(file.contents, _objectSpread(_objectSpread({}, babelOpts), {}, {
        filename: file.path,
    ...
    function createStream(src) {
      ...
      return _vinylFs.default.src(src, {
        allowEmpty: true,
        base: srcPath
      }).pipe((0, _gulpIf.default)(f => !disableTypeCheck && isTsFile(f.path), (0, _gulpTypescript.default)(tsConfig))).pipe((0, _gulpIf.default)(f => lessInBabelMode && /\.less$/.test(f.path), (0, _gulpLess.default)(lessInBabelMode || {}))).pipe((0, _gulpIf.default)(f => isTransform(f.path), _through.default.obj((file, env, cb) => {
        try {
